...
# For instance, ./reducefields.py input.in output.out -l genus specificEpithet decimalLongitude decimalLatitude
...
os.system("sed -i 's/genus_specificEpithet/Species/g' {0}".format(args.output_file))
os.system("sed -i 's/decimalLongitude/x/g' {0}".format(args.output_file))
os.system("sed -i 's/decimalLatitude/y/g' {0}".format(args.output_file))
